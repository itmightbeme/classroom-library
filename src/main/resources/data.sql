...
INSERT INTO users (dtype, name, email, username, password, subject, class_grade, classroom, student_id, pin, reading_level) VALUES
                                                                                                                                    ...
                                                                                                                                    ('STUDENT', 'Oliver Smith', 'oliver.smith@example.com', NULL, NULL, NULL, NULL, NULL, 'OS05', '1234', 3.9),
                                                                                                                                    ('STUDENT', 'Sophia Davis', 'sophia.davis@example.com', NULL, NULL, NULL, NULL, NULL, 'SD06', '1234', 4.0),
                                                                                                                                    ('TEACHER', 'Ms. Thompson', 'thompson@example.com', 'thompson', 'teach123', 'Reading', '3rd', 'Room 12', NULL, NULL, NULL),
                                                                                                                                    ('TEACHER', 'Mr. Bennett', 'bennett@example.com', 'bennett', 'teach456', 'Science', '4th', 'Room 15', NULL, NULL, NULL);
